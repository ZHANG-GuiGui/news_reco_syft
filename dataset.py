...
class BaseDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        clicknews = torch.stack([entity["title"] for entity in item["clicked_news"]]).long()
        candidatenews = torch.stack([entity["title"] for entity in item["candidate_news"]]).long()
        news = torch.cat((candidatenews,clicknews),0)
